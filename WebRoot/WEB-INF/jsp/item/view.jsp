    ...
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        ...
        <p class="font16 c_66" style="margin-top:25px;">
            ...
            <font class="red font20">
                <fmt:formatNumber type="number" value="${obj.price * (obj.zk/10)}" pattern="#.00"/>
                元
                <span style="text-decoration: line-through; color: lightgrey">${obj.price} 元</span>
            </font>
        </p>
        ...
        <p class="font16 c_66 likeColor" style="margin-top: 25px;">
            ...
            <font class="font14 c_99" style="margin-left: 20px;">库存 ${100 - obj.gmNum}</font>
            <script>
                var tr = $("#t_a").val();
