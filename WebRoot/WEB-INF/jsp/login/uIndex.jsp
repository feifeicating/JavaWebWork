        ...
        <div class="left_yh Selected" style="width: 230px;height: 45px;" id="hiddenShow">
            ...
            <div class="downSlide">
                <c:forEach items="${lbs}" var="data" varStatus="l">
                    <div class="n1Nav" style="width: 230px">
        ...
        <div class="normalPic">
            <c:forEach items="${zks}" var="data" varStatus="l">
                <a href="${ctx}/item/view?id=${data.id}">
                    ...
                    <img src="${data.url1}" width="105" height="118" alt="" style="margin:0 auto;padding: 20px 0 20px 0">
                    <p class="red font14" style="padding-left: 10px;text-align: center;">
                        <fmt:formatNumber type="number" value="${data.price * (data.zk/10)}" pattern="#.00"/>
                             元
                        <span style="text-decoration: line-through; color: lightgrey">${data.price} 元</span>
                    </p>
                </a>
            </c:forEach>
        </div>
